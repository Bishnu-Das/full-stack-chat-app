...
function SignupPage() {
  ...
  const validateForm=()=>{
    ...
    if(!/\S+@\S+\.\S+/.test(formData.email)) return toast.error("Invalid email formant");
    if(!formData.password) return toast.error("Password is required");
    if(formData.password.length<6) return toast.error("Password must be at least 6 charactes");
